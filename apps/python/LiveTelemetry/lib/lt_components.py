...
class Height(BoxComponent):
    ...
    def __init__(self, resolution, wheel, window_id):
        ...
        if Height.texture_id == 0:
            Height.texture_id = ac.newTexture("apps/python/LiveTelemetry/img/height.png")
...
class Load(BoxComponent):
    ...
    def __init__(self, resolution):
        ...
        if Load.texture_id == 0:
            Load.texture_id = ac.newTexture("apps/python/LiveTelemetry/img/load.png")
...
class Pressure(BoxComponent):
    ...
    def __init__(self, resolution, wheel, window_id):
        ...
        if Pressure.texture_id == 0:
            Pressure.texture_id = ac.newTexture("apps/python/LiveTelemetry/img/pressure.png")
...
class Suspension(BoxComponent):
    ...
    def __init__(self, resolution, wheel):
        ...
        if Suspension.texture_id == 0:
            Suspension.texture_id = ac.newTexture("apps/python/LiveTelemetry/img/suspension.png")
